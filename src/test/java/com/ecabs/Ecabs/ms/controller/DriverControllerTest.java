...
class DriverControllerTest {
    ...
    void shouldRegisterDriverSuccessfully() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/driver/register")
                ...
                .andExpect(jsonPath("$.message").value("Driver successfully registered!"))
                .andExpect(jsonPath("$.driver.driverId").value(1L))
                .andExpect(jsonPath("$.driver.name").value("Matheus"))
                .andExpect(jsonPath("$.driver.car").value("HONDA-HRV"))
                .andExpect(jsonPath("$.driver.currentLocation.currentLocationX").value(10.0))
                .andExpect(jsonPath("$.driver.currentLocation.currentLocationY").value(20.0))
    ...
    void shouldUpdateDriverSuccessfully() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/driver/{driverId}/update", driverId)
                ...
                .andExpect(jsonPath("$.message").value("Driver information updated successfully!"))
                .andExpect(jsonPath("$.driver.name").value("Matheus"))
                .andExpect(jsonPath("$.driver.car").value("HONDA-HRV"))
                .andExpect(jsonPath("$.driver.currentLocation.currentLocationX").value(10.0))
                .andExpect(jsonPath("$.driver.currentLocation.currentLocationY").value(20.0))
